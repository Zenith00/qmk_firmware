...
#define Z_ESC LT(KC_ESC, KC_GRV)

#define Z_TABPAD LT(_NUMPAD,KC_TAB)
 ...
 */
  [_QWERTY] = LAYOUT(
  //,----------------------------------------------------------------------------.                    ,---------------------------------------------------.
  QK_GESC ,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,             LT(_SWITCH,KC_6), KC_7,   KC_8,    KC_9,    KC_0,    KC_MINUS,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  Z_TABPAD, KC_Q,KC_W,KC_E,  KC_R,    KC_T,                       KC_Y,    KC_U,   KC_I,    KC_O,    KC_P,    KC_BSPC,
  //|------+-------+--------+--------+--------+------                   |--------+-------+--------+--------+--------+---------|
  XXXXXXX,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_MUTE,  KC_D_MUTE,KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                KC_LCTL , KC_LALT, KC_LOWER, KC_SPC,  KC_ENT   ,     KC_SPC, KC_ENT ,  KC_RAISE, KC_RCTL, KC_LGUI
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
...
//* |--------------+----------+--------------+-----------+---------------+---------|                      |-----------+----------+-------------+-----------+------------+------|
  LALT(KC_TAB), LSG(KC),    KC_2,    KC_3,    KC_4,   KC_5,                          KC_6,   KC_7,    KC_8,    KC_9,    KC_0,  KC_F12,
//* |--------------+----------+--------------+-----------+---------------+---------|                      |-----------+----------+-------------+-----------+------------+------|
...
[_SWITCH] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  TO(0),   XXXXXXX, XXXXXXX, XXXXXXX, TO(4),   TO(5),                      TO(6),   KC_NO,   KC_NO,   KC_NO,   KC_NO,   QK_BOOT,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
