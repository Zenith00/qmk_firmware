 ...
 */
  [_QWERTY] = LAYOUT(
  //,------------------------------------------------.                    ,---------------------------------------------------.
  QK_GESC ,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,             LT(_SWITCH,KC_6), KC_7,   KC_8,    KC_9,    KC_0,    KC_GRV,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 KC_LALT, KC_LGUI, KC_LOWER, KC_SPC,  KC_ENT   ,     KC_SPC, KC_ENT ,  KC_RAISE, KC_RCTL, KC_RALT
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
...
//* |--------------+----------+--------------+-----------+---------------+---------|                      |-----------+----------+-------------+-----------+------------+------|
  LALT(KC_TAB), KC_1,    KC_2,    KC_3,    KC_4,   KC_5,                          KC_6,   KC_7,    KC_8,    KC_9,    KC_0,  KC_F12,
//* |--------------+----------+--------------+-----------+---------------+---------|                      |-----------+----------+-------------+-----------+------------+------|
